<template>
  <div class="dashboard-container">
    ...
    <div class="sofa-header">
      ...
      <h1 class="sofa-name">
        <span class="sofa-text">Mevolit</span>
        <span class="sofa-separator"> - </span>
        <span class="sofa-full">Hardware &<br>Software Companion</span>
      </h1>
      <p class="sofa-tagline">
        Mevolit supports MacAdmins by efficiently tracking and surfacing information on updates for macOS, iOS, tvOS, watchOS, visionOS, and Safari.
      </p>
