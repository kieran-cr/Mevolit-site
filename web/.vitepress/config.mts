...
export default defineConfig({
  title: "Mevolit",
  titleTemplate: "Mevolit - Device Updates",
  description: "Hardware & Software Companion. Track all your devices' software updates in one smart, unified place.",
  cleanUrls: true,
  ...
  head: [
    ['link', { rel: 'icon', href: '/mevolit_logo.png' }],
    ['link', { rel: 'apple-touch-icon', href: '/mevolit_logo.png' }],
